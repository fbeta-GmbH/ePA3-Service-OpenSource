...
class TestDocumentUpload:
    ...
    def test_upload_document_success(self, client, mock_send_document_to_epa, sample_xml_content):
    ...
    def test_upload_document_with_custom_uuid(self, client, mock_send_document_to_epa, sample_xml_content):
        mock_send_document_to_epa.return_value = None
    ...
    def test_upload_document_with_old_uuid(self, client, mock_send_document_to_epa, sample_xml_content):
        mock_send_document_to_epa.return_value = None
    ...
    def test_upload_document_missing_kvnr(self, client, sample_xml_content):
        files = {
            'file': ('test_document.xml', io.BytesIO(sample_xml_content), 'application/xml')
        }
        data = {
    ...
    def test_upload_document_missing_title(self, client, sample_xml_content):
        files = {
            'file': ('test_document.xml', io.BytesIO(sample_xml_content), 'application/xml')
        }
        data = {
    ...
    def test_upload_document_missing_creation_time(self, client, sample_xml_content):
        files = {
            'file': ('test_document.xml', io.BytesIO(sample_xml_content), 'application/xml')
        }
        data = {
    ...
    def test_upload_document_missing_file(self, client):
        ...
        response = client.post('/epa/3.0/documents', data=data)

        assert response.status_code == 422

    def test_upload_document_epa_service_error(self, client, mock_send_document_to_epa, sample_xml_content):
    ...
    def test_upload_document_file_not_found_error(self, client, mock_send_document_to_epa, sample_xml_content):
    ...
    def test_upload_document_unexpected_error(self, client, mock_send_document_to_epa, sample_xml_content):
    ...
    def test_sentry_error_reporting(self, mock_sentry, client, mock_send_document_to_epa, sample_xml_content):
    ...
    def test_upload_large_document(self, client, mock_send_document_to_epa):
    ...
    def test_upload_multiple_documents_sequentially(self, client, mock_send_document_to_epa, sample_xml_content):
        mock_send_document_to_epa.reset_mock()
        mock_send_document_to_epa.side_effect = None
        mock_send_document_to_epa.return_value = None
    ...
    def test_upload_document_special_characters_in_title(self, client, mock_send_document_to_epa, sample_xml_content):
        mock_send_document_to_epa.reset_mock()
        mock_send_document_to_epa.side_effect = None
        mock_send_document_to_epa.return_value = None
